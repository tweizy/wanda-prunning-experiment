# Theoretical Analysis: Llama-2-7b-hf
...
- **Most affected task:** rte (9.39% accuracy drop)
- **Least affected task:** piqa (2.07% accuracy drop)
...
- 50% sparsity: 25.45% perplexity increase (manageable)
- 70% sparsity: 1245.40% perplexity increase (severe)
